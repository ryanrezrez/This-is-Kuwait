document.addEventListener("DOMContentLoaded", function() {
    ...
    function isElementInViewport(el) {
        ...
        return rect.top >= 0 && rect.left >= 0 && rect.bottom - 300 <= (window.innerHeight || document.documentElement.clientHeight);
    }
...
const image = document.getElementsByClassName("image-item");
for (let i = 0; i < 8; i++) {
